...
export const DEFAULT_CATEGORIES: Category[] = [
  ...
  { id: '4', slug: 'tools', name: 'Tools', description: 'Power tools, hand tools, toolboxes, ladders, generators', icon_name: 'Wrench', sort_order: 4, is_active: true, created_at: new Date().toISOString() },
  ...
  { id: '12', slug: 'home-goods', name: 'Home Goods', description: 'Rugs, lamps, kitchenware, artwork, storage bins', icon_name: 'Home', sort_order: 12, is_active: true, created_at: new Date().toISOString() },
  { id: '13', slug: 'collectibles', name: 'Collectibles', description: 'Antiques, vintage items, vinyl records, instruments', icon_name: 'Sparkles', sort_order: 13, is_active: true, created_at: new Date().toISOString() },
  { id: '14', slug: 'scrap-materials', name: 'Scrap / Materials', description: 'Copper, aluminum, metal scrap, pallets, raw salvage', icon_name: 'Recycle', sort_order: 14, is_active: true, created_at: new Date().toISOString() },
  { id: '15', slug: 'other', name: 'Other', description: 'Miscellaneous cleanout and fast-turnaround items', icon_name: 'Box', sort_order: 15, is_active: true, created_at: new Date().toISOString() },
];
